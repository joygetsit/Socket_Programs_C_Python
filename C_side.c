...
#define SendtoUDPSocket_IP "127.0.0.1"//"10.0.0.3"
#define ReceiveUDPSocket_IP "127.0.0.1"//"10.0.0.4"//
...
int main(int argc, char* argv[])
{
    ...
    FILE *fpt;
    fpt = fopen("/home/joy/Documents/HapticTestbedLinux/Working_Testbed/Data_and_Plots/Timing_HD_decoy.csv", "w+");
